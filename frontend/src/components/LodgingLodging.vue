<template>
    <v-card style="width:450px; height:100%;" outlined>
        ...
        <v-card-text>
            ...
            <String label="Image" v-model="value.image" :editMode="editMode" :inputUI="''"/>
            <String label="ThumbNail" v-model="value.thumbNail" :editMode="editMode" :inputUI="''"/>
            ...
            <Number label="MapX" v-model="value.mapX" :editMode="editMode" :inputUI="''"/>
            <Number label="MapY" v-model="value.mapY" :editMode="editMode" :inputUI="''"/>
            <Number label="MLevel" v-model="value.mLevel" :editMode="editMode" :inputUI="''"/>
